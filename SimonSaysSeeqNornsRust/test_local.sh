...
if [ "$MODE" = "simulation" ]; then
    ...
    echo "  - Interactive controls: 'space' + Enter to run/stop (with RGB flash), 1-4/QWER/ASDF/ZXCV for 4x4 macropad, 'p' to quit"
    echo ""
...
echo "  'space' + Enter: Run/stop sequencer with RGB flash (simulation mode)"
echo "  1-4/QWER/ASDF/ZXCV + Enter: 4x4 Framework RGB Macropad simulation"
echo "  'p' + Enter: Quit (simulation mode)"
