...
if [ "$MODE" = "simulation" ]; then
    ...
    echo "  - MIDI events logged to console"
    echo "  - Grid operations simulated"
    echo "  - Screen output logged"
    echo ""
...
echo "  Grid: Interactive sequencing"
echo "  Encoders: Parameter control"
echo ""
