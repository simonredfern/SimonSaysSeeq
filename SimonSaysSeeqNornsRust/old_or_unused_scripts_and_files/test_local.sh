...
if [ "$MODE" = "simulation" ]; then
    ...
    echo "  - Interactive controls: 'space' + Enter to run/stop, 1-4/QWER/ASDF/ZXCV for 4x4 grid simulation, 'p' to quit"
    echo ""
...
echo "  'space' + Enter: Run/stop sequencer (simulation mode)"
echo "  1-4/QWER/ASDF/ZXCV + Enter: 4x4 grid simulation"
